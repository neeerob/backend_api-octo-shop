...
let ModeratorService = class ModeratorService {
    constructor(moderatorRepo, adminRepo, userRepo, sellerRepo) {
    ...
    editModerator(editModerator, id) {
...
ModeratorService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(moderator_entity_1.ModeratorEntity)),
